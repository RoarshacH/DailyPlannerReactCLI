...
const ListItem = prop => {
  ...
  return (
    <View style={styles.wrapper}>
      {completed ? (
        <Text style={styles.doneTextStyle}>{title}</Text>
      ) : (
        <Text style={styles.notDoneTextStyle}>{title} </Text>
      )}
      {completed ? (
        <Text style={styles.doneTextStyle}>{date}</Text>
      ) : (
        <Text style={styles.notDoneTextStyle}>{date} </Text>
      )}
